...
public class Driver {
	...
	public static String getFlights(String date, String origin, String destination) {
		try {
			return Console.searchFlight(date, origin, destination);
	...
	public static String getItineraries(String date, String origin, String destination) {
		try {
			return Console.searchItineraries(date, origin, destination);
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
	...
	public static String getItinerariesSortedByCost(String date, String origin, String destination) {
		try {
			return Console.searchItinerariesPrice(date, origin, destination);
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
	...
	public static String getItinerariesSortedByTime(String date, String origin, String destination) {
		try {
			return Console.searchItinerariesDuration(date, origin, destination);
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
